...
# IMPORTANT: Run from clinepower directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"clinepower:subagent-driven-development"' "$SESSION_FILE"; then
