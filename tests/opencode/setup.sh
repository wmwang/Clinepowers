...
mkdir -p "$HOME/.config/opencode/clinepower"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/clinepower/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/clinepower/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/clinepower/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/clinepower.js" "$HOME/.config/opencode/clinepower/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/clinepower/.opencode/plugins/clinepower.js" \
       "$HOME/.config/opencode/plugins/clinepower.js"
...
echo "Plugin installed to: $HOME/.config/opencode/clinepower/.opencode/plugins/clinepower.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/clinepower.js"
