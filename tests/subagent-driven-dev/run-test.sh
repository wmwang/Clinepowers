...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/clinepower
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/clinepower-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using clinepower:subagent-driven-development. The plan is at: $PLAN_PATH"
